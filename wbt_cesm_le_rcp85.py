...
for ens in [34, 35, 101, 102, 103, 104, 105]:
    ...
    while k < nt:
        ...
        for i, var in enumerate(['TREFHTMX', 'QBOT', 'PSL']):
            fn = '/home/dl875/data/cesm_le/rcp85/{:}/b.e11.BRCP85C5CNBDRD.f09_g16.{:03d}.cam.h1.{:}.{:}0101-{:}1231.nc'.format(var, ens, var, yr1, yr2)
            f = nc.Dataset(fn, 'r')
    ...
    # save WBT
    f = nc.Dataset('/home/dl875/data/cesm_le/rcp85/wbtmx.{:03d}.{:}0101-{:}1231.nc'.format(ens, yr1, yr2), 'w')
    #
